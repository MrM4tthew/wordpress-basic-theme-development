...
function phpforwp_theme_styles()
{
  ...
  wp_enqueue_style('phpforwp-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans|Varela+Round', array(), '1.0', 'all');
  // Enque main style sheet (make dependent on google fonts)
  wp_enqueue_style('phpforwp-styles', get_stylesheet_uri(), array('phpforwp-fonts'), get_the_time());
}
